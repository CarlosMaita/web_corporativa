...
@section('title')
    <meta name="description" content="Somos distribuidores y queremos que con un clic desde la comodidad de tu hogar o negocio, puedas hacer tus pedidos. Hacemos entregas hasta tu puerta de tu negocio.">
    <meta name="keywords" content="distribuidores, pedidos al mayor en valencia, pedidos al mayor en carabobo, entregas de productos al mayor en carabobo">
    ...
    <div class="swiper-container text-white swiper-container-fade swiper-container-horizontal skrollable skrollable-between" data-top-top="transform: translateY(0px);" data-top-bottom="transform: translateY(250px);" style="transform: translateY(0px);">
      <div class="swiper-wrapper">
        <div class="swiper-slide vh-100 swiper-slide-prev" >
          <div class="image" style="background-image:url({{asset('images/portada/home_2.png')}})"></div>
          <div class="caption">
            <div class="container">
              <div class="row justify-content-between vh-100">
                <div class="col-md-8 align-self-center" data-swiper-parallax-y="-250%" >
                  <span class="eyebrow text-primary mb-1">Nosotros</span>
                  <h1 class="display-5 font-weight-bold text-uppercase text-white">Distrialimentos<br>del centro</h1>
                </div>
              </div>
            </div>
          </div>
   ...
   <div class="container">
     <div class="row align-items-center">
       <div class="col-md-6 pr-md-5 d-none d-md-block">
         <img style ="border-radius: 50%;" src="{{asset('images/cta/clientes.png')}}" alt="Image">
       </div>
     
       <div class="col-md-6 pr-md-4">
        <h2>Nuestro <b>PROPOSITO</b></h2>
